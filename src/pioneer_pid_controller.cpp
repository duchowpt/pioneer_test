...
int main(int argc, char** argv)
{
    ...
    double temp_gain = 0;
    ros::param::get("/pioneer_test/controller_gains/body/linear/p", temp_gain);
    linear_gains[0] = temp_gain;
    ros::param::get("/pioneer_test/controller_gains/body/linear/i", temp_gain);
    linear_gains[1] = temp_gain;
    ros::param::get("/pioneer_test/controller_gains/body/linear/d", temp_gain);
    linear_gains[2] = temp_gain;
    ros::param::get("/pioneer_test/controller_gains/body/angular/p", temp_gain);
    angular_gains[0] = temp_gain;
    ros::param::get("/pioneer_test/controller_gains/body/angular/i", temp_gain);
    angular_gains[1] = temp_gain;
    ros::param::get("/pioneer_test/controller_gains/body/angular/d", temp_gain);
